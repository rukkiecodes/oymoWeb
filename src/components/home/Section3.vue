    ...
    <v-row justify="space-between" align="center">
      <v-col cols="12" sm="4" class="d-flex justify-center justify-lg-start">
        <v-card width="400" flat>
          <v-card-text>
            <img src="../../assets/images/reels.png" style="width: 100%" />
          </v-card-text>
        </v-card>
      </v-col>
      ...
      <v-col cols="12" sm="4">
        <v-card flat>
          <v-card-title class="title text-uppercase text-body-1"
            >Stay entertained</v-card-title
          >
          <v-card-text class="text-h5 text-sm-h4 font-weight-medium"
            >Stay entertained with our wide array of short videos😎😎</v-card-text
          >
